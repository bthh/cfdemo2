...
@Component({
  selector: 'app-review-summary-alternate',
  standalone: true,
  imports: [
    CommonModule,
    ButtonModule,
  ...
  template: `
    <div class="review-summary-alternate">
      ...
      <div class="registrations-grid">
        <div *ngFor="let account of accountSummaries" class="registration-card">
          <div class="card-content">
            <div class="registration-header">
              <h3 class="registration-title">{{account.name}}</h3>
              <div class="registration-meta">{{getOwnerText(account)}}</div>
          ...
          <div class="card-footer">
            <div class="completion-status">
              <span class="completion-percentage">{{account.completionPercentage}}% Complete</span>
              <span class="completion-sections">{{account.completedSections}}/{{account.totalSections}} sections</span>
            </div>
...
export class ReviewSummaryAlternateComponent {
  ...
  private calculateAccountSummaries() {
    ...
    this.accountSummaries = accountData.map(account => {
      ...
      if (account.id === 'trust-account') {
        ...
        completedSections = 2; // Hardcode for demo
  ...
  getOwnerText(account: AccountSummary): string {
